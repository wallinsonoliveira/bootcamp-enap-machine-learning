...
st.markdown("Acesse o link **[Sobre o Projeto]** ao lado ou acesso o GitHub.")
st.markdown("GitHub do Projeto: https://github.com/wallinsonoliveira/bootcamp-enap-machine-learning")